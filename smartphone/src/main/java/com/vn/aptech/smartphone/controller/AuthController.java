...
public class AuthController {
    ...
    public ResponseEntity<Void> logout(@UserPrincipal UserDetails currentUser,
        ...
        IAuthService.logout(currentUser, refreshToken);
